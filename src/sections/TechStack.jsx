        ...
        <div className="tech-grid">
          {techStackIcons.map((techStackIcon) => (
            ...
            {techStackImgs.map((techStackImg) => (
                <div key={techStackImg.name} className="card-border tech-card overflow-hidden group xl:rounded-full rounded-lg">
                    <div className="tech-card-animated-bg" />
                    <div className="tech-card-content">
                        <div className="tech-icon-wrapper"> <img src={techStackImg.imgPath} /> </div>
                        <div className="padding-x w-full"> <p>{techStackImg.name}</p> </div>
                    </div>
                </div>
            ))}
        </div>
