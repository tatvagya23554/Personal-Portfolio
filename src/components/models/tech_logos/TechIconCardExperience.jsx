...
const TechIconCardExperience = ({ model }) => {
  ...
  useEffect(() => {
    ...
    //   scene.scene.traverse((child) => {
    //     if (child.isMesh) {
    //       if (child.name === "Plane.001_0") {
    //           child.material = new THREE.MeshStandardMaterial({ color: "#FF0000" });//red
    //       }
    //     }
    //   });
    // }
  ...
  // useEffect(() => {
  //   if (model.name === "Cloud Engineer") {
  //       scene.scene.traverse((child) => {
  //           if (child.isMesh) {
  //               if (child.name === "ArrowBody_Material.001_0" || child.name === "ArrowHead_Material.001_0") {
  //                   child.material = new THREE.MeshStandardMaterial({ color: new THREE.Color("gold") });// golden-yellow
  //               }
  //           }
  //       });
  //   }
